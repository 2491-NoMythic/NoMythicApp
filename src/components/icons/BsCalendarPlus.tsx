export default function BsCalendarPlus(props) {
    return (
        <svg
            fill="currentColor"
            stroke-width="0"
        ...
        >
            <path d="M8 7a.5.5 0 01.5.5V9H10a.5.5 0 010 1H8.5v1.5a.5.5 0 01-1 0V10H6a.5.5 0 010-1h1.5V7.5A.5.5 0 018 7z"></path>
