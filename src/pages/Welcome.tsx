                ...
                fallback={
                    <div class="card lg:card-side bg-base-100 shadow-xl mt-10 max-w-5xl">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                It looks like google didn't log you in. You must
                                first have a working Google Email account to
                                login. A school account will work. You can still
                                continue into the guest area if you would like.
                            </p>
                ...
                <Match when={isLoggedIn()}>
                    <div class="card lg:card-side bg-base-100 shadow-xl mt-10 max-w-5xl">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                It looks like google logged you in, but you are
                                not a member of NoMythic.{' '}
                                {googleUser().fullName}, if there has been an
                                error, contact a mentor. In the future we will
                                have more collaboration options for logged in
                                users.
                            </p>
                            <div class="card-actions justify-end">
                                <button
